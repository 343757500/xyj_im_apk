...
import com.xyj.tencent.wechat.event.MessageEvent;
import com.xyj.tencent.wechat.event.RefreshEvent;
...
public class ChatPresenter implements Observer {
     ...
     * @param message 发送的消息
     */
    public void sendMessage(final TIMMessage message, final SendMsgBean sendMsgBean) {
        conversation.sendMessage(message, new TIMValueCallBack<TIMMessage>() {
            ...
            public void onSuccess(TIMMessage msg) {
                ...
                view.onSendMessageSuccess(msg,sendMsgBean);
